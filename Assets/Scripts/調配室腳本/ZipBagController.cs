...
public class ZipBagController : MonoBehaviour
{
    [Header("物件參考")]
    ...
    public GameObject singleZiplockBag3;  // 第三個單個夾鏈袋物件
    ...
    private bool ziplockBag3Shown = false; // 第三個單個夾鏈袋是否顯示
    ...
    void Start()
    {
        ...
        singleZiplockBag3.SetActive(false);
    }
